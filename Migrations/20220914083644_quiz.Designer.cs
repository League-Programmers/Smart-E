            ...
            modelBuilder.Entity("Smart_E.Models.Courses.Assessment", b =>
                {
                    ...
                    b.Property<Guid>("TypeOfAssestypeAssesId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TypeOfAssestypeAssesId");
            ...
            modelBuilder.Entity("Smart_E.Models.Courses.TypeOfAsses", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            typeAssesId = new Guid("6cfeea7f-dfb6-4d7d-aa6b-fc06c0420912"),
                            typeAssesName = "Quiz"
                        },
                        new
                        {
                            typeAssesId = new Guid("f9213464-98b2-4bd9-aabf-37d0fed63b2c"),
            ...
            modelBuilder.Entity("Smart_E.Models.Courses.Assessment", b =>
                {
                    ...
                    b.HasOne("Smart_E.Models.Courses.TypeOfAsses", "TypeOfAsses")
                        .WithMany()
                        .HasForeignKey("TypeOfAssestypeAssesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Course");

                    b.Navigation("TypeOfAsses");
                });
