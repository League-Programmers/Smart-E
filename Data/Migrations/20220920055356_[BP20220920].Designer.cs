...
namespace Smart_E.Data.Migrations
{
    ...
    [Migration("20220920055356_[BP20220920]")]
    partial class BP20220920
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smart_E.Models.Document", b =>
                {
                    ...
                    b.Property<int?>("EventBookingBookingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EventBookingBookingId");

                    b.ToTable("Documents");
                });

            modelBuilder.Entity("Smart_E.Models.Events.BookingDetails", b =>
                {
                    ...
                    b.Property<string>("BookingApproval")
                        .IsRequired()
                        .HasColumnType("nvarchar(1)");

                    b.Property<DateTime>("BookingApprovalDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("BookingCompletedFlag")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Smart_E.Models.Events.EventBooking", b =>
                {
                    b.Property<int>("BookingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smart_E.Models.Events.EventTypeModel", b =>
                {
            ...
            modelBuilder.Entity("Smart_E.Models.Document", b =>
                {
                    b.HasOne("Smart_E.Models.Events.EventBooking", null)
                        .WithMany("Documents")
                        .HasForeignKey("EventBookingBookingId");
                });
