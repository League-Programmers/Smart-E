...
namespace Smart_E.Controllers
{
   public class AccountController : Controller

    {
        ...
        //         var user = await _userManager.Users.SingleOrDefaultAsync(x => x.UserName == model.Email);
        ...
        //             /*if (!user.Status)
        //             {
        //                 ModelState.AddModelError(string.Empty, "User account disabled.");

        //                 return View("Login-center", model);
        //             } */
        ...
        //         /*var emailResult = await _techlaEmailService.SendMail(new SendMailRequestModel()
        //         {
        //             Attachments = new List<Attachment>(),
        //             From = new EmailAddress()
        //             {
        ...
        //             },
        //             Headers = new Dictionary<string, string>(),
        //             HtmlContents = $"Please reset your password by clicking here: <a href='{callbackUrl}'>link</a>",
        //             PlainTextContents = "Forgot Password",
        //             ReplyTo = new EmailAddress() { Email = "no-reply@techla.co.za", Name = "no-reply" },
        //             ReportingAttributes = new List<EmailEntryReportingAttributeModel>(),
        //             ReportingIdentifier = "",
